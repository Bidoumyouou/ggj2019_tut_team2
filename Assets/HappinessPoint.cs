...
public class HappinessPoint : MonoBehaviour
{
    public Text Text;
    ...
    void Start()
    {
        ...
        TextCurrentGravity = GameManager.GetComponent<GameMgr>().scoreHappiness;
    }

    // Update is called once per frame
    void Update()
    {
        int nowPoint = GameManager.GetComponent<GameMgr>().scoreHappiness;
